...
import '../../../core/services/services_local.dart';
              ...
              background: FadeIn(
                ...
                child: ShaderMask(
                  ...
                  child: CachedNetworkImage(
                    ...
                    imageUrl: ApiConstance.urlImage(state.movieDetail!.backdropPath),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
          ...
          (context, index)  {
            ...
            return  FadeInUp(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: ApiConstance.urlImage(recommendation.backdropPath!),
